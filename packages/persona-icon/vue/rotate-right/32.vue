<template>
  <svg
    ...
    fill="none"><path
      fill="#000"
      d="M14.43 2.333a.973.973 0 0 0-1.39-.074 1.011 1.011 0 0 0-.072 1.412l.824.931H8.325c-2.664 0-4.823 2.194-4.823 4.9v6.5c0 .553.44 1 .984 1a.992.992 0 0 0 .985-1v-6.5c0-1.601 1.278-2.9 2.854-2.9h5.467l-.825.931c-.363.41-.33 1.043.074 1.413a.973.973 0 0 0 1.39-.075l2.303-2.6c.337-.38.337-.957 0-1.338l-2.303-2.6Z" /><path
        fill="#000"
        fill-rule="evenodd"
