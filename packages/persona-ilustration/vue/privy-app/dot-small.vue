<template>
  <svg
    ...
    viewBox="0 0 40 40"><g clip-path="url(#5f_a)"><rect
      width="20.523"
      height="14.97"
      x="18.168"
      y="12.515"
        ...
        clip-rule="evenodd" /><path
          ...
          d="M18.168 13.668c0-.637.516-1.153 1.153-1.153h18.216c.637 0 1.153.516 1.153 1.153v.667H18.168z" /><rect
            ...
            rx="1.104" /><rect
              ...
              rx="1.104" /><path
                fill="#353535"
                d="M16.235 4.383a1.199 1.199 0 1 1-2.398 0z" /><path
                  fill="#EA4F4A"
                  fill-rule="evenodd"
                        ...
                        stop-opacity=".054" /><stop
                          ...
                          stop-opacity=".106" /><stop
                            ...
                            stop-opacity=".192" /><stop
                              offset=".387"
                              stop-opacity=".245" /><stop offset="1" /></linearGradient><clipPath id="5f_a"><path
                                fill="#fff"
